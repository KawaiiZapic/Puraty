...
then
	...
	sqlite3 $APPREG "INSERT INTO properties (handlerId, name, value) VALUES ($APP_ID_STRING,'command','/usr/bin/mesquite -l $APP_ID -c file://$APP_FOLDER/waf/')"
fi
...
# Installed mark
touch $APP_FOLDER/installed

echo "Puraty has been installed."