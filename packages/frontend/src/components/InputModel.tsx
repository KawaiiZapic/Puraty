...
export const Input = (
	props: IntrinsicElementsHTML["input"] & { modelValue?: Ref<string> }
) => {
	const $ = h("input", {
		...props,
...
export const Checkbox = (
	props: IntrinsicElementsHTML["input"] & { modelValue?: Ref<boolean | string> }
) => {
	const $ = h("input", {
		...props,
		type: "checkbox",
...
export const Select = (
	props: IntrinsicElementsHTML["select"] & { modelValue?: Ref<string> }
) => {
	const $ = h(
		"select",
		{
